...
local keywordMap = {
    -- starter towers!!
    ["Scout"] = { file = "DefaultScout3.png", category = "starter" },
    ["Sniper"] = { file = "DefaultSniperIcon1.png", category = "starter" },
    ["Paintballer"] = { file = "NewPaintballerIcon.png", category = "starter" },
    ["Demoman"] = { file = "DefaultDemomanIcon2.png", category = "starter" },
    ["Hunter"] = { file = "NewHunterIcon.png", category = "starter" },
    ["Soldier"] = { file = "KrampusRevengeSoldierIcon.png", category = "starter" },

    -- intermediate towers!!
    ["Militant"] = { file = "EasterMilitant_Icon.png", category = "intermediate" },
    ["Medic"] = { file = "DefaultMedicIconn.png", category = "intermediate" },
    ["Freezer"] = { file = "ReworkedFreezerIcon.png", category = "intermediate" },
    ["Farm"] = { file = "DefaultFarmIcon.png", category = "intermediate" },
    ["Shotgunner"] = { file = "EasterShotgunner_Icon.png", category = "intermediate" },
    ["Rocketeer"] = { file = "RocketeerIcon2025.png", category = "intermediate" },
    ["Trapper"] = { file = "TrapperIcon.png", category = "intermediate" },
    ["Ace Pilot"] = { file = "DefaultAcePilotIconIGJ24.png", category = "intermediate" },
    ["Pyromancer"] = { file = "DefaultPyromancerIcon.png", category = "intermediate" },
    ["Military Base"] = { file = "DefaultMilitaryBaseIconM29.png", category = "intermediate" },
    ["Crook Boss"] = { file = "CBRCBossIcon.png", category = "intermediate" },

    -- advanced towers!!
    ["Electroshocker"] = { file = "DefaultElectroshockerIcon2.png", category = "advanced" },
    ["Commander"] = { file = "Commandernew.png", category = "advanced" },
    ["Warden"] = { file = "Warden.png", category = "advanced" },
    ["Cowboy"] = { file = "WDDefaultCowboyIcon.png", category = "advanced" },
    ["DJ Booth"] = { file = "DefaultDJBoothIconAug2024.png", category = "advanced" },
    ["Minigunner"] = { file = "NewMinigunner.png", category = "advanced" },
    ["Ranger"] = { file = "Newranger.png", category = "advanced" },
    ["Pursuit"] = { file = "DefaultPursuitIconIGNov24.png", category = "advanced" },
    ["Gatling Gun"] = { file = "DefaultGatlingGunIconIG.png", category = "advanced" },
    ["Turret"] = { file = "DefaultTurretIcon.png", category = "advanced" },
    ["Mortar"] = { file = "MortarIcon.png", category = "advanced" },
    ["Mercenary Base"] = { file = "Mercenary_base_image.png", category = "advanced" },

    -- hardcore towers!!
    ["Brawler"] = { file = "BrawlerFromTDS.png", category = "hardcore" },
    ["Necromancer"] = { file = "NecromancerTowerIcon.png", category = "hardcore" },
    ["Accelerator"] = { file = "DefaultAcceleratorIcon2.png", category = "hardcore" },
    ["Engineer"] = { file = "EngineerIcon.png", category = "hardcore" },
    ...
    -- exclusive towers!!
    ["Gladiator"] = { file = "GladiatorIconn.png", category = "exclusive" },
    ["Commando"] = { file = "NewCommandoIcon.png", category = "exclusive" },
    ["Slasher"] = { file = "HexscapeSlasherIcon.png", category = "exclusive" },
    ["Frost Blaster"] = { file = "KRFrostBlasterIcon.png", category = "exclusive" },
    ["Archer"] = { file = "DHDefaultArcherIcon.png", category = "exclusive" },
    ["Swarmer"] = { file = "NewDefaultSwarmerIcon.png", category = "exclusive" },
    ["Toxic Gunner"] = { file = "ToxicGIcon.png", category = "exclusive" },
    ["Sledger"] = { file = "OICESledgerIcon.png", category = "exclusive" },
    ["Executioner"] = { file = "DefaultExecutioner2.png", category = "exclusive" },
    ["Elf Camp"] = { file = "Elf_Camp_Tower_Icon.png", category = "exclusive" },
    ["Jester"] = { file = "JesterIcon.png", category = "exclusive" },
    ["Cryomancer"] = { file = "OICECryomancerIcon.png", category = "exclusive" },
    ["Hallow Punk"] = { file = "HallowPunkIcon.png", category = "exclusive" },
    ["Harvester"] = { file = "DefaultHarvesterIconIG.png", category = "exclusive" },
    ["Snowballer"] = { file = "SnowballerIcon.png", category = "exclusive" },
    ["Elementalist"] = { file = "ElementalistIcon.png", category = "exclusive" },
    ["Firework Technician"] = { file = "FireworkTechnicianIcon.png", category = "exclusive" },
    ["War Machine"] = { file = "WarMachineIcon.png", category = "exclusive" },
    ["Mecha Base"] = { file = "OUMechaBaseIcon.png", category = "exclusive" },
    ["Sentry"] = { file = "Sentry.png", category = "exclusive" },
