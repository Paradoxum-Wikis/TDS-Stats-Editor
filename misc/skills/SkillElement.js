  ...
  updateElement(skillDiv) {
    ...
    if (currentLevel < this.skill.maxLevel && this.costBreakdownCallback) {
      ...
      if (breakdown.credits > 0) {
        parts.push(`${breakdown.credits.toLocaleString()} <img src="/htmlassets/SkillCredit.png" alt="Skill Credits" class="cost-icon">`);
      }
    ...
    if (currentLevel > 0 && this.skillSpendingCallback) {
      ...
      if (actualSpending.credits > 0) {
        totalParts.push(`${actualSpending.credits.toLocaleString()} <img src="/htmlassets/SkillCredit.png" alt="Skill Credits" class="cost-icon">`);
      }
      if (actualSpending.coins > 0) {
        totalParts.push(`${actualSpending.coins.toLocaleString()} <img src="/htmlassets/Coin.png" alt="Coins" class="cost-icon">`);
      }
