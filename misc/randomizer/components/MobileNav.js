...
function setupClonedEventListeners(container) {
  ...
  if (clonedPreselectedTowersContainer) {
    ...
    container.querySelector('#preselectedTowerCount').textContent = `${appState.preselectedTowers.length}/5 towers selected`;
  }
  ...
  if (clonedExcludedMapsContainer) {
    ...
    container.querySelector('#excludedMapCount').textContent = `${appState.excludedMaps.length} maps excluded`;
  }
  ...
  if (clonedExcludedTowersContainer) {
    ...
    container.querySelector('#excludedTowerCount').textContent = `${appState.excludedTowers.length} towers excluded`;
  }
