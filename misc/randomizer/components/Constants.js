...
export const UI_ELEMENTS = {
  ...
  randomizedResultsContainer: document.getElementById('randomized-results-container'),
  ...
  preselectedTowersContainer: document.getElementById('preselectedTowersContainer'),
