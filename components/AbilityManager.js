...
export default class AbilityManager {
    ...
    setupEventListeners() {
        this.abilityAddButton.addEventListener('click', () => {
            ...
            if (abilities) {
                ...
                const defaults = this.viewer.getActiveSkin()?.defaults?.data || 
    ...
    getAbilities() {
        ...
        if (skinData?.Defaults?.Abilities) return skinData.Defaults.Abilities;
        if (skinData?.Default?.Defaults?.Abilities) return skinData.Default.Defaults.Abilities;
        if (skinData?.data?.Abilities) return skinData.data.Abilities;
        if (skinData?.defaults?.data?.Abilities) return skinData.defaults.data.Abilities;
        if (skinData?.defaults?.attributes?.Abilities) return skinData.defaults.attributes.Abilities;
