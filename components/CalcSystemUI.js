class CalcSystemUI {
    ...
    setupEventListeners() {
        this.calcSystemToggle.addEventListener('click', () => this.toggleCalcSystem());
        this.sidebarToggle.addEventListener('click', () => this.updateFloatingPanel());

        // dragging func
        this.floatingCalcSystem.addEventListener('mousedown', (e) => this.handleMouseDown(e));
    ...
    toggleCalcSystem() {
        ...
        const isSidebarCollapsed = this.mainContainer.classList.contains('sidebar-collapsed');
